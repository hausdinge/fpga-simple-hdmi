...
architecture STRUCTURE of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_clk_wiz_0_clk_wiz is
  ...
  signal clk_out_250MHz_clk_wiz_0 : STD_LOGIC;
  signal clk_out_250MHz_clk_wiz_0_en_clk : STD_LOGIC;
  signal clk_out_25MHz_clk_wiz_0 : STD_LOGIC;
  signal clk_out_25MHz_clk_wiz_0_en_clk : STD_LOGIC;
...
clkout1_buf_en: unisim.vcomponents.BUFH
     port map (
      I => clk_out_25MHz_clk_wiz_0,
      O => clk_out_25MHz_clk_wiz_0_en_clk
    );
...
clkout2_buf_en: unisim.vcomponents.BUFH
     port map (
      I => clk_out_250MHz_clk_wiz_0,
      O => clk_out_250MHz_clk_wiz_0_en_clk
    );
mmcm_adv_inst: unisim.vcomponents.MMCME2_ADV
    generic map(
      ...
      CLKOUT0 => clk_out_25MHz_clk_wiz_0,
      CLKOUT0B => NLW_mmcm_adv_inst_CLKOUT0B_UNCONNECTED,
      CLKOUT1 => clk_out_250MHz_clk_wiz_0,
...
\seq_reg1_reg[0]\: unisim.vcomponents.FDRE
    generic map(
      INIT => '0'
        ...
        port map (
      C => clk_out_25MHz_clk_wiz_0_en_clk,
      CE => '1',
      D => \^locked\,
      Q => seq_reg1(0),
      R => '0'
...
\seq_reg2_reg[0]\: unisim.vcomponents.FDRE
    generic map(
      INIT => '0'
        ...
        port map (
      C => clk_out_250MHz_clk_wiz_0_en_clk,
      CE => '1',
      D => \^locked\,
      Q => seq_reg2(0),
      R => '0'
