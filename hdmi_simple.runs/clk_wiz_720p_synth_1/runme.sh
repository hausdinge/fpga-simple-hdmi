...
HD_PWD='C:/Users/hausd/Dateien/Xilinx_proj/hdmi_simple/hdmi_simple.runs/clk_wiz_720p_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log clk_wiz_720p.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source clk_wiz_720p.tcl
