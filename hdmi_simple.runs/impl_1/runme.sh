...
HD_PWD='C:/Users/hausd/Dateien/Xilinx_proj/hdmi_simple/hdmi_simple.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log top_hdmi_out.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source top_hdmi_out.tcl -notrace
