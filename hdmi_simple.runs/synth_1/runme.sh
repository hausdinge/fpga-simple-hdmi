...
HD_PWD='C:/Users/hausd/Dateien/Xilinx_proj/hdmi_simple/hdmi_simple.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log top_hdmi_out.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source top_hdmi_out.tcl
